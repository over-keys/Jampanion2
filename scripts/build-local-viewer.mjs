...
html = html
  ...
  .replaceAll("../icons/jampanion-viewer.png?v=43", viewerIconUrl)
  .replaceAll('./help.html?v=43', ONLINE_VIEWER_URL + 'help.html?v=43')
  .replaceAll('./help.en.html?v=43', ONLINE_VIEWER_URL + 'help.en.html?v=43')
  .replace(
  ...
  <script type="module" data-jampanion-embedded-bridge="v12">
    ...
    if (isStandaloneViewer) {
      ...
      import("../js/jazz-chart-host.js?v=43").then(({ initializeEmbeddedViewer }) => {

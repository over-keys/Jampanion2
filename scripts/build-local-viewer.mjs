...
html = html
  ...
  .replaceAll("../icons/jampanion-viewer.png?v=49", viewerIconUrl)
  .replaceAll('./help.html?v=49', ONLINE_VIEWER_URL + 'help.html?v=49')
  .replaceAll('./help.en.html?v=49', ONLINE_VIEWER_URL + 'help.en.html?v=49')
  .replace(
  ...
  <script type="module" data-jampanion-embedded-bridge="v12">
    ...
    if (isStandaloneViewer) {
      ...
      import("../js/jazz-chart-host.js?v=49").then(({ initializeEmbeddedViewer }) => {

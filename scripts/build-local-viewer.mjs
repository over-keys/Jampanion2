...
html = html
  ...
  .replaceAll("../icons/jampanion-viewer.png?v=39", viewerIconUrl)
  .replaceAll('./help.html?v=39', ONLINE_VIEWER_URL + 'help.html?v=39')
  .replaceAll('./help.en.html?v=39', ONLINE_VIEWER_URL + 'help.en.html?v=39')
  .replace(
  ...
  <script type="module" data-jampanion-embedded-bridge="v12">
    ...
    if (isStandaloneViewer) {
      ...
      import("../js/jazz-chart-host.js?v=39").then(({ initializeEmbeddedViewer }) => {

...
checks = {
    ...
    "revert is next to accompaniment save": 'RevertCurrentSongAsync' in logic and 'CanRevertCurrentSong' in home and 'revertCurrentSong' in host and 'heading-actions' in home,
    "main Save shows centered Saved feedback": 'SaveButtonText' in logic and 'SaveButtonText = "Saved"' in logic and '@SaveButtonText' in home and 'justify-content:center' in (root / "integration/overlay/src/Jampanion.Web/wwwroot/css/jazz-integration.css").read_text(),

...
checks = {
    ...
    "mobile controls are separated from the mix": 'jamp-mobile-controls' in home and 'grid-row:3' in (root / "integration/overlay/src/Jampanion.Web/wwwroot/css/jazz-integration.css").read_text(),
    ...
    "mobile playback hides non-session controls": '.jamp-shell.is-playing .accompaniment-panel { display:none; }' in (root / "integration/overlay/src/Jampanion.Web/wwwroot/css/jazz-integration.css").read_text() and '.jamp-shell.is-playing .session-panel { width:auto;' in (root / "integration/overlay/src/Jampanion.Web/wwwroot/css/jazz-integration.css").read_text(),

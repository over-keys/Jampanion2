...
checks = {
    ...
    "mobile playback scrolls the active bar": 'scrollPlaybackTarget(target)' in host and 'const embeddedMobile = mobile && window.parent !== window;' in host and 'if (!embeddedMobile)' in host and 'window.parent.scrollBy' in host and 'Math.abs(delta) > 12' in host,

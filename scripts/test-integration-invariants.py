...
checks = {
    ...
    "desktop brand row is at pane bottom": '.jamp-brand-row { order:99; margin-top:auto;' in (root / "integration/overlay/src/Jampanion.Web/wwwroot/css/jazz-integration.css").read_text(),

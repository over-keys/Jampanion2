...
checks = {
    ...
    "cache-busted page versions": 'APP_VERSION = "30"' in (root / "scripts/customize-shell.mjs").read_text() and 'help.html?v=30' in (root / "scripts/customize-viewer.mjs").read_text() and 'help.en.html?v=30' in (root / "scripts/customize-viewer.mjs").read_text() and 'jazz-chart-host.js?v=31' in (root / "scripts/customize-viewer.mjs").read_text() and 'help.css?v=30' in (root / "scripts/customize-help.mjs").read_text() and 'jazz-chart-host.js?v=43' in logic and 'viewer/index.html?integrated=13' in home,

...
checks = {
    ...
    "cache-busted page versions": 'APP_VERSION = "27"' in (root / "scripts/customize-shell.mjs").read_text() and 'help.html?v=27' in (root / "scripts/customize-viewer.mjs").read_text() and 'help.en.html?v=27' in (root / "scripts/customize-viewer.mjs").read_text() and 'jazz-chart-host.js?v=15' in (root / "scripts/customize-viewer.mjs").read_text() and 'help.css?v=27' in (root / "scripts/customize-help.mjs").read_text() and 'jazz-chart-host.js?v=28' in logic and 'viewer/index.html?integrated=13' in home,

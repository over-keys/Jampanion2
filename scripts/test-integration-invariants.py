...
checks = {
    ...
    "viewer toolbar always keeps Rev.": 'jampanionStandaloneRevert' in host and 'standaloneRevertButton.hidden = false' in host and 'revertButton.textContent = "Rev."' in host and 'originalSourceRecord?.body' in host,
    ...
    "viewer toolbar owns Save and Revert": 'SaveChartFromToolbar' in logic and 'RevertChartFromToolbar' in logic and 'toolbarSave' in host and 'toolbarRevert' in host and 'fitButton.after(button, revertButton)' in host and 'heading-actions' not in home,

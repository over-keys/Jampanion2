...
checks = {
    ...
    "section style is shown beside rehearsal marks": 'jamp-section-style' in host and 'sectionStyleAbbreviation' in host and 'case "Swing": return "Sw"' in host and 'case "JazzBallad": return "Ba"' in host and 'case "BossaNova": return "Bo"' in host and 'case "AfroCubanLatin": return "La"' in host and 'current?.remove()' in host and 'badge.textContent !== styleLabel' in host,

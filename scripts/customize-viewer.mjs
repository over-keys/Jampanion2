...
html = html.replaceAll('href="./help.html"', 'href="./help.html?v=29"');
html = html.replaceAll('href="./help.en.html"', 'href="./help.en.html?v=29"');
...
if (!html.includes(marker)) {
  ...
  const freshBridge = bridge.replace('jazz-chart-host.js?v=22', 'jazz-chart-host.js?v=24');

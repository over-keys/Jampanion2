...
checks = {
    ...
    "startup shell is standalone": 'Jampanion2' in index and '<strong>Jampanion</strong>' not in index and 'const APP_VERSION = \"34\"' in index,
    "cache-busted page versions": 'APP_VERSION = \"34\"' in index and 'help.html?v=34' in viewer_source and 'help.en.html?v=34' in viewer_source and 'help.css?v=34' in help_source and 'jazz-chart-host.js?v=34' in viewer_source and 'jazz-chart-host.js?v=34' in logic and 'viewer/index.html?integrated=34' in home,
    ...
    "mobile CSS cache is bumped": 'jazz-integration.css?v=34' in home,
    ...
    "background playback does not stop on page visibility": 'visibilityHandler' not in host and 'StopSessionFromVisibility' not in host and 'jampanion-page-hidden' not in browser_source and 'jampanion-audio.js?v=34' in logic,

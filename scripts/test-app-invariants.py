...
checks = {
    ...
    "startup shell is standalone": 'Jampanion2' in index and '<strong>Jampanion</strong>' not in index and 'const APP_VERSION = \"35\"' in index,
    "cache-busted page versions": 'APP_VERSION = \"35\"' in index and 'help.html?v=35' in viewer_source and 'help.en.html?v=35' in viewer_source and 'help.css?v=35' in help_source and 'jazz-chart-host.js?v=37' in viewer_source and 'jazz-chart-host.js?v=37' in logic and 'viewer/index.html?integrated=37' in home,
    ...
    "mobile CSS cache is bumped": 'jazz-integration.css?v=35' in home,
    ...
    "background playback does not stop on page visibility": 'visibilityHandler' not in host and 'StopSessionFromVisibility' not in host and 'jampanion-page-hidden' not in browser_source and 'jampanion-audio.js?v=35' in logic,
    "published shell version matches": '"version": "35"' in (root / "src/Jampanion.Web/wwwroot/app-version.json").read_text(),
    ...
    "broad stale workers are removed": 'baseUrl.href.startsWith(scope.href)' in index and 'scope.href.startsWith(baseUrl.href)' in index,

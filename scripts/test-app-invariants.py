...
checks = {
    ...
    "startup shell is standalone": 'Jampanion2' in index and '<strong>Jampanion</strong>' not in index and 'const APP_VERSION = \"45\"' in index,
    "cache-busted page versions": 'APP_VERSION = \"45\"' in index and 'help.html?v=45' in viewer_source and 'help.en.html?v=45' in viewer_source and 'help.css?v=45' in help_source and 'jazz-chart-host.js?v=45' in viewer_source and 'jazz-chart-host.js?v=45' in logic and 'viewer/index.html?integrated=45' in home,
    "online viewer bridge is direct and cache-busted": 'import { initializeEmbeddedViewer } from "../js/jazz-chart-host.js?v=45"' in viewer_source and 'initializeEmbeddedViewer().catch' in viewer_source,
    ...
    "mobile CSS cache is bumped": 'jazz-integration.css?v=45' in home,
    ...
    "background playback does not stop on page visibility": 'visibilityHandler' not in host and 'StopSessionFromVisibility' not in host and 'jampanion-audio.js?v=45' in logic,
    "published shell version matches": '"version": "45"' in (root / "src/Jampanion.Web/wwwroot/app-version.json").read_text(),

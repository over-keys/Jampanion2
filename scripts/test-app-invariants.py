...
checks = {
    ...
    "cache-busted page versions": 'APP_VERSION = \"35\"' in index and 'help.html?v=35' in viewer_source and 'help.en.html?v=35' in viewer_source and 'help.css?v=35' in help_source and 'jazz-chart-host.js?v=35' in viewer_source and 'jazz-chart-host.js?v=35' in logic and 'viewer/index.html?integrated=35' in home,

...
grep -q 'APP_VERSION = "28"' "$ROOT/scripts/customize-shell.mjs"
grep -q 'help.html?v=28' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'help.en.html?v=28' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'help.css?v=28' "$ROOT/scripts/customize-help.mjs"
grep -q 'jazz-chart-host.js?v=20' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'jazz-chart-host.js?v=33' "$ROOT/integration/overlay/src/Jampanion.Web/Pages/IntegratedHomeLogic.cs"

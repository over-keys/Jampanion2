...
grep -q 'jazz-chart-host.js?v=25' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'jazz-chart-host.js?v=37' "$ROOT/integration/overlay/src/Jampanion.Web/Pages/IntegratedHomeLogic.cs"

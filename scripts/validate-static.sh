...
grep -q 'jazz-chart-host.js?v=30' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'jazz-chart-host.js?v=42' "$ROOT/integration/overlay/src/Jampanion.Web/Pages/IntegratedHomeLogic.cs"

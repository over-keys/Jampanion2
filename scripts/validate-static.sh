...
grep -q 'APP_VERSION = "30"' "$ROOT/scripts/customize-shell.mjs"
grep -q 'help.html?v=30' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'help.en.html?v=30' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'help.css?v=30' "$ROOT/scripts/customize-help.mjs"
grep -q 'jazz-chart-host.js?v=31' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'jazz-chart-host.js?v=43' "$ROOT/integration/overlay/src/Jampanion.Web/Pages/IntegratedHomeLogic.cs"

...
grep -q 'jazz-chart-host.js?v=22' "$ROOT/scripts/customize-viewer.mjs"
grep -q 'jazz-chart-host.js?v=34' "$ROOT/integration/overlay/src/Jampanion.Web/Pages/IntegratedHomeLogic.cs"
